...
// منع التمرير باللمس تماماً
  (function() {
    function preventTouch(e) {
      e.preventDefault();
    }
    // استخدم { passive: false } حتى نتمكن من استدعاء preventDefault
    document.addEventListener('touchmove', preventTouch, { passive: false });

    // لإعادة التفعيل لاحقًا:
    // document.removeEventListener('touchmove', preventTouch);
  })();



  // يمنع النقر بالزر الأيمن (سلوك بسيط فقط)
document.addEventListener('contextmenu', e => e.preventDefault());

// يمنع F12/Ctrl+Shift+I (يمكن تجاوزه بسهولة)
